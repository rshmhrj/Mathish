...
//		String PT10  = Convert.HexToString(PT10H);
		...
		System.out.println("Key is currently: " + key.length() + " and needs to be: " + len);
...
//		System.out.println(PT10);
		...
		Hkey = BitwiseXOR.XOR(CT06, Convert.StringToHex("There are two types of cryptography: "), false);
