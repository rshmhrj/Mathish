...
public class MergeSort
{
   ...
   public static int[] mergeArray(int A_length, int[] B, int B_length, int[] C,
         int C_length)
   {
   ...
   public static void again(int[] A, int n)
   {
      ...
      System.out
            .println("Do you want to run again?  0 = No.  1 = Yes with Same array.  2 = Yes with Different array.");
      int again = input.nextInt();
      while (!isValidAgain(again))
      {
         System.out
               .println("0 = No.  1 = Yes with Same array.  2 = Yes with Different array.");
         again = input.nextInt();
      }
      switch (again)
      {
