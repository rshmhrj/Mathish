...
public class countMinimumCuts
{
   ...
   {
      System.out
            .println("This program will count the minimum number of cuts in a given Adjacency List.");
      body();
   ...
   public static void body() throws IOException
   {
      ...
      // long[][] test = AdjacencyList.generateArrayFromAdjacencyListLong("P3",
      // "kargerAdj (1)", 40);
   ...
   public static void countMinCuts(int numberOfExecutions) throws IOException
   {
      ...
      minimumCuts = MinimumCuts.cut(AdjacencyList
            .generateArrayFromAdjacencyListInt("P3", "kargerAdj (1)", 40));
      while (iterationCounter <= numberOfExecutions)
      {
         int newMinCut = MinimumCuts.cut(AdjacencyList
               .generateArrayFromAdjacencyListInt("P3", "kargerAdj (1)", 40));
