...
public class FibonacciSequenceLoop {
	...
	/**
	 * @param args
	 * This program will generate the first x numbers of the Fibonacci sequence.
	 * Starting with 0 and 1, each next number is the result of the addition of the previous two numbers.
	 */
