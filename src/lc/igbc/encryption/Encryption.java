...
public class Encryption
{
   ...
   public static void Encrypt() throws IOException
   {
      ...
      System.out
            .println("Please enter the name of the file (in D:\\Test) that you want to read.  Do not include the '.txt'");
      enterName();
      setFile(fileName);
      getFile();
   }
   ...
   public static void isValidFileName(String name)
   {
      ...
      {
         System.out
               .println("Invalid Name.  Please enter the name of the file (without D:\\Test and without the .txt).");
         enterName();
      }
      else
      {
