...
//        return (t, s - q * t)
	...
	public static boolean isPythagoreanMultiple(int[][] triples, int a, int b, int c) 
	{
		boolean match = false;
		for (int[] list : triples)
		{
			...
			else if (a%list[0] == 0 && b%list[1] == 0 && c%list[2] == 0 && a/list[0] == b/list[1] && b/list[1] == c/list[2])
			{
				match = true;
				break;
			}
			else if (b%list[0] == 0 && a%list[1] == 0 && c%list[2] == 0 && b/list[0] == a/list[1] && a/list[1] == c/list[2])
			{
				match = true;
				break;
			}
