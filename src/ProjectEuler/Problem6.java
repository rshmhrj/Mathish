...
public class Problem6
{
    ...
    *           difference between the sum of the squares of the first ten
   ...
   public static void main(String[] args)
   {
      ...
      System.out
            .println("This program will find the difference between the 'sum of the squares' and the 'square of the sum' of the first x numbers.");
