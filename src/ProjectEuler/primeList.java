...
public class primeList
{
   ...
   public static void main(String[] args)
   {
      ...
      System.out
            .println("This program is to test the time to generate primes using both nested 'fors' and separate methods.");
      ...
      System.out.println("****The Program took " + timeMethod
            + "ms to execute using the Methods.****");
      System.out.println("****The Program took " + timeFors
            + "ms to execute using the nested Fors.****");
