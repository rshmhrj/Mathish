...
public class Problem3 {
	...
	public static void main(String[] args) {
		...
		int largest = (int)squareRoot(num); // find the squareRoot of the number
		int root = largest+1;
		...
		int[] primeFactors = generatePrimeFactors(num, primeList.length, primeList);
		...
		System.out.println("****The Program took "+totalTimeMS+"ms to execute.****");
...
//		} // end for
	...
	public static int[] generatePrimeFactors(long num, int pnum, int[] primeList){
