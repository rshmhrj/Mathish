...
public class ColonelBlotto {
	...
	{
		System.out.println("This program will give you the minimum number of 'fronts' necessary for a smaller force to win");
		body();
	...
	public static void body()
	{
		...
		System.out.println("Minimum Number of Fronts needed is ::" + Integer.toString(numberOfFronts));
	}
